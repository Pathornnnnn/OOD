...
def init_data():
    ...
    album3.add_url("https://example.com/into_the_new_era.jpg")
    song5 = Song(5, "Do You", 260)
    song5.add_url("https://example.com/do_you.mp3")
    song6 = Song(6, "Rap Thai United", 275)
    song6.add_url("https://example.com/rapthai_united.mp3")
